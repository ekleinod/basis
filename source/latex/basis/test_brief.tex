...
%\usepackage[draft|final, font=charter|hfold|mathpazo|original|times, hypercolor=<color>, hyperdriver=<driver>, layout=kopfzeile|infospalte, nobackaddress, nofoldmarks, oneside, pagestyle=beides|fuss|leer]{basbrief}
