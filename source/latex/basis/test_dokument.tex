...
%\usepackage[draft|final, font=charter|droid|hfold|mathpazo|original|times, fontsize=<groesse>, hypercolor=<color>, hyperdriver=<driver>, notitlepage, oneside, protocol, pagestyle=beides|fuss|fussseite|leer, rules]{basis}
