...
Mögliche Optionen: \option{draft}, \option{final}, \option{font}, \option{fontsize}, \option{hypercolor}, \option{hyperdriver}, \option{layout}, \option{nobackaddress}, \option{nofoldmarks}, \option{notitlepage}, \option{oneside}, \option{protokoll}, \option{pagestyle}
...
Die \option{protokoll}-Option nimmt Änderungen für Protokolle vor.
Die Option wird nur bei Artikeln oder Büchern ausgewertet.
...
\begin{nutzung}
		\>\befehl{usepackage[protokoll]\{basis\}}\\
\end{nutzung}
